...
<?php 
	$id = @$_GET['id'];
	$sql= mysqli_query($con,"SELECT * FROM tbl_surat_keluar where  id='$id'") or die(mysqli_error($con));
	$row = mysqli_fetch_array($sql);
 ?>
<div class="panel panel-default">
  <div class="panel-heading">Lihat Data Surat Keluar</div>
	  <div class="panel-body">
	  		<div class="box" style="margin-left: 170px;">
				...
				<div class="form-group col-md-6">
					<label>Tertuju Kepada</label> <p><?php echo $row['tertuju']; ?></p>
				</div>
				<div class="form-group col-md-6">
					<label>Alamat</label> <p><?php echo $row['alamat']; ?></p>
				</div>
				<div class="form-group col-md-6">
