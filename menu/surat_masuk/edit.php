...
<div class="panel panel-default">
  <div class="panel-heading">Edit Data Surat Masuk</div>
				...
				<div class="row">
					<form method="POST" action="proses.php">
						...
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" required="required" autofocus id="InputPengirim" name="pengirim" placeholder="Pengirim" value="<?php echo $row['pengirim']?>">
							<span class="help-block"></span>
						</div>
						<div class="form-group col-md-6">
							<label for="InputPerihal">Perihal</label>
							<input type="text" class="form-control" required="required" id="InputPerihal" name="perihal" placeholder="Perihal" value="<?php echo $row['perihal']?>">
							<span class="help-block"></span>
						</div>
						<div class="form-group col-md-6">
							<label for="InputSifat">Status Disposisi</label>
							<select class="form-control" required id="InputStatus" name="status_disposisi">
								<option selected>-Silahkan Pilih-</option>
								<option selected hidden="hidden"><?php echo $row['status_disposisi']; ?></option>
