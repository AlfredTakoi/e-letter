        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Welcome <?=$_SESSION['level'];?><span class="caret"></span> <img class="profile-img-card" src="../../_assets/assetslogin/img/avatar_2x.png" width="25" style="border-radius: 50%; margin-right: 5px;"></a>
