...
<div class="panel panel-default">
  <div class="panel-heading">Input Laporan Surat Keluar</div>
	  <div class="panel-body">
	  	<div class="box">
			<div class="row">	
				<form method="POST" action="cetakkeluar.php" target="_blank">
					<div class="form-group col-md-6" >
						<label for="InputNo">Tanggal Awal</label>
						<input type="date" class="form-control" required="required" autofocus id="InputNo" name="tgl_awal" placeholder="No. Surat" value="<?php if (isset($_POST['tgl_awal'])) echo $_POST['tgl_awal']; echo date("d-m-Y");?>">
