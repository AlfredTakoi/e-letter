	...
	<center>
		<div class="box">
			<table border="0" width="90%" >
		      <tr>
		        <td width="120">
		          <img src="../../_assets/img/Logo-Cimahi .png" alt="logo1" width="120" style="margin-bottom: 20px;">
		        </td>
		        <td align="center">
		          	<p align="center" style="margin-bottom: --1in; line-height: 50%"><font face="Times New Roman, serif"><font size="5" style="font-size: 12pt;"><b>PEMERINTAH KOTA CIMAHI</b></font></font></p>
			...
			<div>
				 <font face="Times New Roman" color="black" size="4"> <p align="center"> <u> <b> DATA SURAT KELUAR</b></u></font><br>
	  			<font face="Times New Roman" color="black" size="4"> Nomor: ....../......./<?php echo date('Y'); ?> </p></font><br>
	  			<font face="Times New Roman" color="black" size="4">Laporan Surat Keluar dari Tanggal <?php echo tgl_indonesia($_POST['tgl_awal']); ?> sampai dengan tanggal <?php echo tgl_indonesia($_POST['tgl_akhir']); ?></p></font>
			</div>
		</div>
	<?php 
	 ...
	 <table class="table table-bordered table-hover" border="1" style="border-collapse: collapse; font-family: serif;">
	        <br>
	        <thead>
	        <tr>
	            <th>No.</th>
	        ...
	        <?php 
	            ...
	            $sql = "SELECT  * from tbl_surat_keluar INNER JOIN tbl_posisi ON tbl_surat_keluar.pengirim = tbl_posisi.id_posisi where tanggal_surat between '".$tgl_awal."' and '".$tgl_akhir."' order by id asc";

	        }else {
	            $sql="SELECT * from tbl_surat_keluar INNER JOIN tbl_posisi ON tbl_surat_keluar.pengirim = tbl_posisi.id_posisi order by id asc";
	        }
	        $no = 1;
